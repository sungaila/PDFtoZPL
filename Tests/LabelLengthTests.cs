...
#pragma warning disable CA1416
        ...
        public void ConvertWithEncodings(string fileName, bool? setLabelLength)
        {
            ...
            var zplResult = fileName.EndsWith(".pdf")
                ? (setLabelLength != null ? ConvertPdfPage(fileStream, pdfOptions: new(Dpi: 203), zplOptions: new(EncodingKind: BitmapEncodingKind.Base64Compressed, SetLabelLength: setLabelLength.Value)) : ConvertPdfPage(fileStream, pdfOptions: new(Dpi: 203), zplOptions: new(EncodingKind: BitmapEncodingKind.Base64Compressed)))
