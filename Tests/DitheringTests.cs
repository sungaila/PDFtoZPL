...
#pragma warning disable CA1416
		...
		public void ConvertWithDithering(string fileName, DitheringKind? ditheringKind)
		{
			...
			var zplResult = fileName.EndsWith(".pdf")
				? ditheringKind != null ? ConvertPdfPage(fileStream, encodingKind: BitmapEncodingKind.Base64Compressed, ditheringKind: ditheringKind.Value) : ConvertPdfPage(fileStream, encodingKind: BitmapEncodingKind.Base64Compressed)
				: ditheringKind != null ? ConvertBitmap(fileStream, encodingKind: BitmapEncodingKind.Base64Compressed, ditheringKind: ditheringKind.Value) : ConvertBitmap(fileStream, encodingKind: BitmapEncodingKind.Base64Compressed);
