...
#pragma warning restore IDE0079
        ...
        public void ConvertWithAntiAliasing(string fileName, PdfAntiAliasing? antiAliasing)
        {
            ...
            var zplResult
                = antiAliasing != null ? ConvertPdfPage(fileStream, 0, pdfOptions: new(Dpi: 203, AntiAliasing: antiAliasing.Value), zplOptions: new(EncodingKind: BitmapEncodingKind.Base64Compressed)) : ConvertPdfPage(fileStream, 0, pdfOptions: new(Dpi: 203), zplOptions: new(EncodingKind: BitmapEncodingKind.Base64Compressed));
